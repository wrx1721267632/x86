         ...
         core_base_address equ 0x00040000   ;常数，内核加载的起始内存地址（将要被加载到的物理内存）
         core_start_sector equ 0x00000001   ;常数，内核的起始逻辑扇区号(在硬盘的位置) 
  ...
  flush:                                  
         ...
         ;以下加载系统核心程序(最开始定义的两个常量，内核加载的起始内存地址和内核的起始逻辑扇区号) 
